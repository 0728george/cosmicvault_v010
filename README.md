...
A permanent, censorship-resistant archive of human knowledge placed intentionally in the public domain or preserved under fair principles for educational and historical purposes.
...
- Static deployment – mirrorable in seconds
...
## License & Usage
All hosted materials are either:
...
## Eternal Mirrors (live as of v0.3.0+)
- IPFS pinning
- Arweave permanent snapshots
- Torrent magnet link
- Distributed Git mirrors (GitHub → GitLab → Codeberg)

“The truth does not burn.”  
— comyandradis, First Keeper — 2025
